...
#include <stdint.h>
#include <stdbool.h>
// Export macro (Windows) / visibility (other platforms)
#if defined(_WIN32)
...
#else
	#define LARKXR_API __attribute__((visibility("default")))
	#define DC_CALL
#endif

#define LARKXR_DC_VERSION_MAJOR			3
#define LARKXR_DC_VERSION_MINOR			2
#define LARKXR_DC_VERSION_REVISE		39
#define LARKXR_DC_VERSION_BUILD			0

#define LARKXR_DC_VERSION "3.2.39.0"
